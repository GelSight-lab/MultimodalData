...
sensors: `cnc_mini_26/` (a commercial GelSight Mini) and
...
from .lut_calibration import (BINS, CAL_OUT, DI_RANGE, CNC_MINI_26, MM_PER_PIXEL,
...
COMMERCIAL = CNC_MINI_26                     # GelSight Mini CNC presses
