# Historical Force Reconstruction Research

This is the pre-v8 research README, retained for provenance. Its force model,
stiffness values, metrics and operational commands are historical, not the
current React processing contract. For v8 use [README.md](README.md) and
[RUNBOOK.md](RUNBOOK.md). Do not use the stamping or publishing commands below
to migrate current data.
