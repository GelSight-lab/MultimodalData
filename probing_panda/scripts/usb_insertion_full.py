...
bc_online_weights = "checkpoints_supercloud/best_2024-05-07_21_03_46-step6_withstate_withpretrainedtactile_base0.7_abs_usb"
# bc_online_weights = "checkpoints_supercloud/best_2024-05-07_20_58_32-step6_withstate_withscratchtactile_base0.7_abs_usb"
# bc_online_weights = "checkpoints_supercloud/best_2024-05-07_20_55_51-step6_withstate_notactile_base0.7_abs_usb"
...
def main():
    ...
    goal_pose.translation = [0.36108827, 0.02599755, 0.08388375]
    ...
    init_pose.translation = [0.49654114, 0.03233815, 0.05803585]
    ...
    step_cnt = 0
    while step_cnt < 30:
        # if step_cnt > 9 and step_cnt % 10 == 0:
        #     cur_pose = planner.agent.get_franka_pose()
